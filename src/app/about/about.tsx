...
import { MdCreditCard, MdEco, MdOutlineCheckCircle } from 'react-icons/md';
    ...
    <div>
      <div className='flex flex-col lg:flex-row justify-between my-20 mx-5 lg:ml-[215px] lg:mr-32 gap-5'>
        <div className='bg-[#007580] lg:w-[672px] lg:h-[478px] rounded-lg p-5'>
            <div className='lg:w-[495px] lg:h-[161px] gap-[12px]'>
                <h3 className='text-3xl font-bold text-[#FFFFFF] text-center lg:text-left lg:mx-14 px-2 pt-10'>About Us - Comforty</h3>
        ...
        <div>
            <img src="/feature1.png" alt="image" className='lg:w-[619px] lg:h-[478px] mx-auto' />
        </div>
      </div>
      ...
      <div className='flex flex-wrap gap-5 justify-center lg:ml-20 mb-10'>
        <div className='w-full sm:w-[630px] mb-5'>
            <img src="/sofabig.png" alt="large sofa set" className='w-full h-[375px] bg-[#F6F6F6]' />
            <div className=''>
                <p className='text-[20px] leading-[28px] text-[#2A254B]'>The Popular suede sofa</p>
                <p className='text-[18px] leading-[27px] text-[#2A254B]'>$99.00</p>
            </div>
        </div>
        <div className='w-full sm:w-[305px] mb-5'>
            <img src="/sofa2.png" alt="sofa2" className='w-full h-[375px] bg-[#F6F6F6]' />
            <div className=''>
                <p className='text-[20px] leading-[28px] text-[#2A254B]'>The Dandy chair</p>
                <p className='text-[18px] leading-[27px] text-[#2A254B]'>$99.00</p>
            </div>
        </div>
        <div className='w-full sm:w-[305px] mb-5'>
            <img src="/sofa3.png" alt="sofa3" className='w-full h-[375px] bg-[#F6F6F6]' />
            <div className=''>
                <p className='text-[20px] leading-[28px] text-[#2A254B]'>The Dandy chair</p>
                <p className='text-[18px] leading-[27px] text-[#2A254B]'>$99.00</p>
            </div>
